...
const STRINGS = {
  ru: {
    ...
    auth_default:   'Аутентификация реализована средствами фреймворка приложения. Конкретный механизм подлежит уточнению при аудите кода.',
    authz_default:  'Авторизация реализована средствами фреймворка; конкретная модель (RBAC/ACL/ABAC) подлежит уточнению при аудите кода.',
